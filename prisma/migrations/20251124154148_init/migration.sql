...
-- CreateEnum
CREATE TYPE "AttendanceStatusEnum" AS ENUM ('REGISTERED', 'ATTENDED', 'ADDED_TO_CART', 'FOLLOW_UP', 'BREAK_OUT_ROOM', 'CONVERTED');

-- CreateEnum
CREATE TYPE "CallStatusEnum" AS ENUM ('PENDING', 'COMPLETED', 'CANCELED');
...
CREATE TABLE "Attendance" (
    ...
    "status" "AttendanceStatusEnum" NOT NULL DEFAULT 'REGISTERED',
    "registeredAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "attendedAt" TIMESTAMP(3),
    "addedToCartAt" TIMESTAMP(3),
    "followUpAt" TIMESTAMP(3),
    "breakOutRoomAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "Attendance_attendeeId_idx" ON "Attendance"("attendeeId");
