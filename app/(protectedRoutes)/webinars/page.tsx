...
const page = async ({ searchParams }: Props) => {
  ...
  return (
    <Tabs
      ...
      >
        <TabsList className='bg-transparent space-x-3 rounded-md'>
          <TabsTrigger
            value='all'
  ...
  xl:grid-cols-4 place-items-start place-content-start
  gap-x-6 gap-y-10"
      >
        {webinars?.length > 0 ? (
