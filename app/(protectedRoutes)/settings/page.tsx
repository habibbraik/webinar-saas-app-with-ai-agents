...
import { AlertCircle, CheckCircle2, LucideArrowRight } from 'lucide-react';
import Link from 'next/link';
import {getStripeAuthLink} from '@/lib/stripe/utilis';
...
const page = async (props: Props) => {
    ...
    return (
        <div className="w-full mx-auto py-8 px-4">
            ...
            <div className="w-full p-6 border border-input rounded-lg
    bg-background shadow-sm">
        ...
        justify-center mr-4">
                ...
                <div className="my-6 p-4 bg-muted rounded-md flex items-start">
                    {isConnected ? (
                        <CheckCircle2
