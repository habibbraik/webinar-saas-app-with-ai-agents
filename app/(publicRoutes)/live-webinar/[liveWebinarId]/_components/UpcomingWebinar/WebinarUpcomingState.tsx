  ...
  return (
    <div className="w-full min-h-screen mx-auto max-w-[400px] flex flex-col justify-center items-center gap-8 py-20">
      <div className="space-y-6">
        ...
        <CountdownTimer
          targetDate={new Date(webinar.startTime ?? Date.now())}
      ...
      <div className="text-center space-y-4">
        ...
        <div className="w-full justify-center flex gap-2 flex-wrap items-center">
          ...
          >
            ...
            {format(new Date(webinar.startTime ?? Date.now()), 'dd MMMM yyyy')}
          </Button>

          <Button variant={'outline'}>
            <Clock className="mr-2" />
            {format(new Date(webinar.startTime ?? Date.now()), 'hh:mm a')}
          </Button>
        </div>
      </div>
    </div>
