...
const MultiStepForm = ({ steps, onComplete }: Props) => {
  const { formData, validateStep, setSubmitting, isSubmitting, setModelOpen } = useWebinarStore();
                    ...
                    <div className="relative">
                      <motion.div
                        ...
                        animate={{
                          backgroundColor: isCurrent || isCompleted
                            ? 'rgb(147 51 234)'
                            : 'rgb(31, 41, 55)',
                          scale: [isCurrent || isCompleted ? 0.8 : 1],
                        }}
                      ...
                      >
                        ...
                        {index < steps.length - 1 && (
                          <div
                            className="absolute top-8 left-4 w-0.5 h-16 bg-gray-700 overflow-hidden"
                          >
                            <motion.div
                              initial={{
